...
<!-- Dashboard Content -->
    ...
    <div class="dashboard-nav">
        ...
        <div class="nav-grid">
            <div class="nav-item">
                <img src="../../images/station_info.jpg" alt="Station Information Management" class="nav-icon">
                <button class="nav-btn">
                    <a href="station_info_management.php">Station Information Management</a>
                </button>
            </div>
            <div class="nav-item">
                <img src="../../images/station_pro.jpg" alt="Station Providings Management" class="nav-icon">
                <button class="nav-btn">
                    <a href="station_providings_management.php">Station Providings Management</a>
                </button>
            </div>
            <div class="nav-item">
                <img src="../../images/blog_icon.jpg" alt="Manage News/Blogs" class="nav-icon">
                <button class="nav-btn">
                    <a href="../environmentalist/viewBlog.php">View News/Blogs</a>
                </button>
            </div>
        </div>
    </div>
...
.nav-grid {
    display: grid;
    grid-template-columns: repeat(3, 1fr); /* Two columns for desktop */
    gap: 5px;
