        ...
        <div class="nav-grid">
            <div class="nav-item">
                ...
                <button class="nav-btn">
                    <a href="environmentalist/account_verification.php">Account Verification with Document</a>
                </button>
            </div>
            <div class="nav-item">
                <img src="../images/blog_icon.jpg" alt="Manage News/Blogs" class="nav-icon">
                <button class="nav-btn">
                    <a href="environmentalist/news_blog_management.php">Manage News/Blogs</a>
                </button>
            </div>
            <div class="nav-item">
                <img src="../images/review_icon.jpg" alt="Manage EV Station Reviews" class="nav-icon">
                <button class="nav-btn">
                    <a href="environmentalist/reviews_management.php">Manage EV Station Reviews</a>
                </button>
            </div>
            <div class="nav-item">
                <img src="../images/profile_icon.jpg" alt="View/Edit Profile" class="nav-icon">
                <button class="nav-btn">
                    <a href="environmentalist/profile.php">View/Edit Profile</a>
                </button>
            </div>
        </div>
    </div>
